...
class Assets {
	...
	private function __construct(){
		...
		add_action('admin_print_styles', function(){
			wp_register_style( 'gt3-gallery-lite-admin-styles', false );
			wp_enqueue_style( 'gt3-gallery-lite-admin-styles' );
			$css = '#adminmenu img{ width: 100%; height: 100%; max-width: 20px; max-height: 20px; }';
			wp_add_inline_style( 'gt3-gallery-lite-admin-styles', $css );
		});
	}
